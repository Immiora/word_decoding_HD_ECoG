...
def main(args):
    ...
    #plot_box_acc(res, title='fig6c_beh_exp3_optimized', plot_dots=args.plot_dots, plotdir=args.plot_dir)
    #res = pd.read_csv(op.join(args.res_path, 'results_avg_over_words_mod.csv'), index_col=[0])
    #plot_box_acc(res, title='fig6c_beh_exp3_models', plot_dots=args.plot_dots, plotdir=args.plot_dir)
